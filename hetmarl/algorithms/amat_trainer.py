...
class AMATTrainer:
    ...
    def ppo_update(self, sample): #TODO: make sure active_masks are used correctly to mask out info after envs are done
        ...
        if not self.use_centralized_training: #unused
            ...
            # print("shape of padded_obs is: ", padded_obs['global_agent_map'].shape)
            # print("shape of concat_obs is: ", concat_obs['global_agent_map'].shape)
            # print("shape of concat actions is: ", np.array(concat_actions).shape)
            for key in obs_batch.keys():
            ...
            # print("shape of concat_obs is now: ", concat_obs['global_agent_map'].shape)
            # print("shape of concat actions is now: ", concat_actions.shape)
