...
class Runner(object):
    def __init__(self, config):
        ...
        self.lr_warmup = self.all_args.lr_warmup
        self.use_linear_entropy_decay = self.all_args.use_linear_entropy_decay
    ...
    def save(self, episode, save_separately=False):
        ...
        if save_separately:
            save_dir = os.path.join(self.save_dir, str(episode))
