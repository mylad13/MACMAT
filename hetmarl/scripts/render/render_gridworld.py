...
@hydra.main(config_path='../config', config_name='hydra_render_config', version_base="1.1") 
def main(config):
    ...
    elif all_args.algorithm_name == "amat" or all_args.algorithm_name == "mat" or all_args.algorithm_name == "mancp" or all_args.algorithm_name == "macmat":
        pass
    ...
    print("algorithm is ", all_args.algorithm_name)
    if all_args.algorithm_name == "macmat":
        print("RNN type is ", all_args.rnn_type)
    # cuda
    ...
    if all_args.use_wandb:
        run = wandb.init(config=all_args_dict,
